...
import { MoveLeft, Undo, Youtube } from "lucide-react";
            ...
            !chapter ?
              <div className="rounded-lg border w-full p-4 px-3 md:px-6 focus-within:shadow-sm grid grid-cols-10 gap-2">
                <div className="col-span-10 lg:col-span-7">
                  <div className="m-0 p-0">
                    ...
                    >
                      ...
                      <div className="flex flex-col justify-center md:justify-start text-center pb-4 md:pr-6 md:py-4 rounded-lg px-4">
                        <p className="text-black/80 font-semibold">{videoInfos.videoTitle.length > 50 ? videoInfos.videoTitle.substring(0, 60) + "..." : videoInfos.videoTitle}</p>
                ...
                <div className="col-span-10 text-center lg:col-span-3 w-full">
                  ...
                  <Button
                    className="col-span-10 mt-3 lg:col-span-3 w-15 bg-secondary text-black/60 hover:bg-secondary/80 hover:text-black/80"
                    onClick={() => { setVideoInfos(undefined), form.reset() }}
                  >
